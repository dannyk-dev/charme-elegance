...
import { Brand, Product, type $Enums } from "@prisma/client";
...
export function EditForm({ data, brands }: iAppProps) {
        ...
        <CardContent>
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <Label>Brand</Label>
              <Select
                key={fields.brandId.key}
                name={fields.brandId.name}
            ...
            <div className="flex gap-3">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input
                  ...
                  defaultValue={data.size || fields.size.initialValue}
                  type="text"
                  placeholder="50ml"
                />
